...
int tahtaTamam(int sira){
    ...
    for (r = 0; r < sira; r++) 
	    if (tahta[sira] == tahta[r] || tahta[sira] == tahta[r] << sira-r || tahta[sira] == tahta[r] >> sira-r)//tahta ilk vezirden baslayarak her dongude 
			return 0; 																						  //bir soraki vezirin yerlesiminin digeriyle iliskisini kontrol ediyor
